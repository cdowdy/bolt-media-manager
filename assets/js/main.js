...
import ApplyImageFilter from './classes/fabric/fabric-image-filters'
import MediaManagerApp from './MediaManagerApp';

// import MediaManagerEdit from './MediaManagerEdit';
...
document.addEventListener( 'DOMContentLoaded', () => {
    let fabricFilter = new ApplyImageFilter();

    fabricFilter.do();
});

// from heydon pickering
...
(function() {
    ...
    Array.prototype.forEach.call(headings, heading => {
        let btn = heading.querySelector('.panel-title-button')
        let target = heading.parentNode.nextElementSibling
...
/** accessible tooltip dialog https://dequeuniversity.com/library/aria/popups-dialogs/sf-tooltip-dialog **/
// helpLink is clicked:
// - focus the tooltip
